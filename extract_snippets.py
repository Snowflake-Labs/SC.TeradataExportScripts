...
arguments_parser = argparse.ArgumentParser(description="MLOAD/BTEQ/FLOAD embedded shell script extractor for SnowConvert")
...
###   mload << !
###   fastload << !
### Any supported extension must have an output suffix of the generated file of the snowconvert tool by that input extension and ouput extension of the snippet, and output that will be generated by the conversion tool
supported_extensions = { "bteq": ("bteq", "_BTEQ.py"), "mload": ("mload","_MultiLoad.py"), "fastload": ("fload", "_FastLoad.py") }
        ...
        if find_extensions_in_text(all_text, supported_extension_keys, supported_extension_tags):
            ...
            while pos < lenLines:
                ...
                if matches:
                    ...
                    snippets.append((newblock, supported_extensions[filetype][0]))
                    file_without_snippets.append(f"@@SNIPPET{len(snippets)}{supported_extensions[filetype][1]}\n")
                    continue
